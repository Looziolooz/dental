...
const SECTION3_BG = '/images/patient.webp'
...
/** Larghezza che l'immagine avrebbe se scalata all'altezza della sezione. */
function useImageWidth(src: string, sectionHeight: number) {
  ...
  useEffect(() => {
    ...
    img.onload = () => setWidth(img.naturalWidth * (sectionHeight / img.naturalHeight))
    img.src = src
  }, [src, sectionHeight])
...
function SectionHero() {
  ...
  const mask = { bgImage: HERO_IMAGE, imageWidth, focalX }
...
function SectionGallery() {
  ...
  const mask = { bgImage: SECTION2_IMAGE, imageWidth, focalX }
      ...
      <div className="flex-1 min-h-0 grid grid-cols-1 md:grid-cols-2 gap-1.5 md:gap-2">
        <div className="flex flex-col gap-1.5 md:gap-2">
          ...
          >
            ...
            <p className="text-xs md:text-sm font-semibold text-black">Sostituisci i denti mancanti</p>
          </div>
          ...
          >
            <div className="flex-1 rounded-xl md:rounded-2xl overflow-hidden">
              ...
              <img
                src={SECTION3_IMG1}
                alt="Inserimento di un impianto dentale"
        ...
        >
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img src={SECTION3_BG} alt="Paziente sorridente" className="w-full h-full object-cover" />
